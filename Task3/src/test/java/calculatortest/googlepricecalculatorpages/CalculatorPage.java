...
public class CalculatorPage extends AbstractPage {
    ...
    WebElement addGPUs;
    private final int noOfInstances = 4;
    ...
    public void addSpecifications() {
        ...
        waitForClickablility(localSSD, Duration.ofSeconds(10));
        localSSD.click();

        WebElement SSDoption = driver.findElement(By.cssSelector("#select_option_490"));

        waitForClickablility(SSDoption, Duration.ofSeconds(10));
        SSDoption.click();
        ...
        waitForClickablility(datacenterOption, Duration.ofSeconds(10));
